...
const styles = StyleSheet.create({
  ...
  statChipIcon:  { fontSize: 30 },
  statChipValue: { fontSize: 25, fontFamily: "Inter_700Bold", color: "#FFF" },
  statChipLabel: { fontSize: 12, fontFamily: "Inter_500Medium", color: "rgba(255,255,255,0.7)", textAlign: "center" },
  cosmeticsTitle: {
