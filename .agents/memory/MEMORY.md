...
- [Copointo tab bar layouts](copointo-tab-bar-layouts.md) — (tabs)/_layout has TWO bars (iOS26 NativeTabs vs Classic); native defaults to BLUE tint, set tintColor amber; preview shows only Classic.
